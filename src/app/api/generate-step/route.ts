...
반드시 정중하고 신뢰감 있는 하십시오체를 사용하며, 고객의 핵심 불편함을 절실하고 생생한 스토리텔링 방식으로 묘사하라.`,
    task: `초기 아이디어를 바탕으로 고객들이 겪는 표면적 불편함 3가지를 선별하고, 각 불편함에 '왜(Why)'라는 질문을 반복 적용하여 근본 원인을 도출하십시오.
...
각 기능을 문제, 고객 가치, 구현 난이도, 검증 지표와 연결하고 필수/권장/선택으로 우선순위를 지정하라.
...
전략적이고 냉철한 해라체를 사용하라. 경쟁 우위를 과장하지 말고 주장마다 검증 근거 또는 검증 계획을 제시하라.`,
    task: `목표 시장에서 경쟁사가 따라오기 어려운 강력한 경쟁 우위(진입 장벽)를 자원과 역량 관점으로 정의하라.
초기 틈새시장을 특정하고 20자 이내의 강력한 가치제안 슬로건을 제시하라.
직접 경쟁사, 간접 대안, 아무것도 하지 않는 선택을 비교한 경쟁 지도를 만들고 초기 안착 이후 인접 시장으로 확장할 3단계 성장 로드맵과 단계별 핵심 성과 지표를 작성하라.`,
  },
  5: {
...
문제 정의, 솔루션과 최소기능제품, 시장·경쟁 분석, 비즈니스 모델, 시장 진출 및 성장 로드맵, 팀, 재무·핵심지표, 위험과 대응, 실행 일정 순서로 구성하라.
...
심사위원단은 수익성 심사위원, 기술성 심사위원, 조직·인력 심사위원, 마케팅·시장진출 심사위원, 확장성 심사위원으로 구성된 익명의 가상 전문가 집단이다.
