    ...
    <div className="flex h-screen bg-slate-900 text-white overflow-hidden relative">
      ...
      <div className="w-1/3 border-r border-white/10 p-12 flex flex-col items-center justify-center text-center bg-slate-900/50 backdrop-blur-xl">
        ...
        <div className="space-y-2">
          <p className="text-blue-400 font-black text-2xl tracking-widest uppercase">포스트 쓰기 링크: <a href={`https://jyp-mentor.web.app/qna/?id=${lectureId}`} target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-300 lowercase">
            https://jyp-mentor.web.app/qna/?id={lectureId}
          </a></p>
